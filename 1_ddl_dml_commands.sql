...
/* 4.To change the table name in sql */
 Alter table customers rename to customer_09
 ==================================================================================================================================
 /* DML commands */
/* 5. To change a particular value inside a table*/
select * from customer_09
update customer_09 set age = 37 where customerID = 1004
select * from customer_09